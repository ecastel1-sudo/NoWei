"""STARE-LB v3 (REWARD GATE) - standalone safe default

This is a standalone copy of the v3 reward-gate variant with a conservative
default SAFETY so it avoids excessive churn while remaining faithful to the
competition reward model. Drop this file as `submission.py` in a submission
archive if you need a single-file upload.
"""
import numpy as np
import time
import torch
...
CLIP_PCTL = 99.0
MIN_PAR = 1.02
# Conservative default safety to avoid excessive churn
SAFETY = 200.0
